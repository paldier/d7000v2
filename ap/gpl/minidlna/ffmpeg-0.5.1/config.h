...
#define FFMPEG_CONFIGURATION "--enable-shared --enable-gpl --arch=mips --cc=mips-openwrt-linux-uclibc-gcc --enable-cross-compile --disable-muxers --disable-encoders --disable-filters --disable-vhook --extra-cflags=-fPIC"
