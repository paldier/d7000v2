...
int main(int argc, char *argv[]) {
	...
	char ntps[32], *next;
	int retry_count = 0;          /* Foxconn added pling 01/25/2016 */
...
again:   /* Foxconn added pling 01/25/2016 */
		/* Startup sequence */
		...
		/* Foxconn added start pling 01/25/2016 */
...
#define NTP_QUERY_SRCPORT 123
			...
			if (udp_local_port == NTP_QUERY_SRCPORT)
				...
				udp_local_port = NTP_QUERY_SRCPORT;
			close(usd);
			goto again;
