...
function subpage_resize()
{
    ...
    if(!is_double) {
		...
		if(get_browser()=="Netscape" || get_browser()=="Firefox")
			$('.container_center').css("top", document.body.scrollHeight >  640+adjustPageHeight ? document.body.scrollHeight :  660+adjustPageHeight); 
		else if(get_browser()=="IE")
			$('.container_center').css("top", document.documentElement.clientHeight >  640+adjustPageHeight ? document.documentElement.clientHeight :  660+adjustPageHeight); 
		else
			$('.container_center').css("top", document.documentElement.scrollHeight >  640+adjustPageHeight ? document.documentElement.scrollHeight :  660+adjustPageHeight); 
    } else{
        $('.container_center').css("width", document.body.clientWidth-40 > 925 ? document.body.clientWidth-40 : 925);
		if(get_browser()=="Netscape" || get_browser()=="Firefox")
