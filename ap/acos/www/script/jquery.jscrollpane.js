...
//alert('pane.outerWidth() '+pane.outerWidth()+' clonedElem.outerWidth() '+clonedElem.outerWidth());
...
//alert("isScrollableH"+isScrollableH);

				//console.log(paneWidth, paneHeight, contentWidth, contentHeight, percentInViewH, percentInViewV, isScrollableH, isScrollableV);
//alert("remove class jspScrollable");
