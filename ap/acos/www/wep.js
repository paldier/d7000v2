...
function checkKey(evt)
{
    ...
    {
        keyTooBig = false;
        alert("<%getstr("ca_10_maxkey");%> " + keysize + " <%getstr("ca_10_char");%>");
    ...
    {
        keyTooBig_an = false;
        alert("<%getstr("ca_10_maxkey");%> " + keysize_an + " <%getstr("ca_10_char");%>");
	...
	else if (lastkeypressed == 13)   // to reject enter key - D6400
		return false;
    return true;
}
